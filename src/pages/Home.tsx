        ...
        <Container maxWidth={false} sx={{ 
          ...
          <Box sx={{ 
            ...
            <Typography variant="h2" sx={{
             ...
             NEW!!!!!  We design and implement smarter observability, log management, and cybersecurity solutions. From architecture to activation, we help you get the most out of tools like Cribl, Splunk, and many others—faster, cleaner, and with confidence.
            </Typography>
